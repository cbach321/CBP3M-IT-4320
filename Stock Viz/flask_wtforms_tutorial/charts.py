...
def make_url(symbol, time_series):
    return "https://www.alphavantage.co/query?function=" + time_series_to_api_text(time_series) + "&symbol=" + symbol + "&interval=5min&outputsize=full&apikey=7N6JOT42TD9M4B1S"
